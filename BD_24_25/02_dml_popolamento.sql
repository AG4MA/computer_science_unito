...
INSERT INTO CentroVisita (ID, nome, parcoID, temporaneamenteChiuso, indirizzo, accessibilità, mostra)
VALUES (1, 'Centro Visitatori Valsavarenche', 1, FALSE, 'Valsavarenche, AO', 'Accesso disabili', 'La vita a sei zampe');
...
INSERT INTO Commento (ID, testo, data, visitatoreID, targetID, tipoTarget)
VALUES (1, 'Bellissimo percorso, ben segnalato.', '2025-07-12', 1, 1, 'itinerario');
...
INSERT INTO Presenza (ID, visitatoreID, parcoID, data, oraIngresso, oraUscita, tipologiaUtente)
VALUES (1, 1, 1, '2025-07-10', '09:00:00', '17:00:00', 'Adulto');

INSERT INTO ItinerarioPercorso (ID, presenzaID, itinerarioID, valutazione, commento)
VALUES (1, 1, 1, 5, 'Sentiero panoramico e ben curato.');
